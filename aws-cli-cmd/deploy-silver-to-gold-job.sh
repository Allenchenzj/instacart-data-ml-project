...
# Upload script to S3
aws s3 cp glue-scripts/silver-to-gold-job.py s3://instacart-aws-data-ml-eng-project/scripts/silver-to-gold-job.py
...
aws glue create-job \
    ...
    --command '{
        "Name": "glueetl",
        "ScriptLocation": "s3://instacart-aws-data-ml-eng-project/scripts/silver-to-gold-job.py",
        "PythonVersion": "3"
    }' \
    --default-arguments '{
        "--job-language": "python",
